                            ...
                            // paganation start 
                              $sql1 = "select *from post
                                       ...
                                       if(mysqli_num_rows($result1) > 0){
                                               ...
                                               echo "<ul class='page'>";
                                               if($page>1){
                                                   echo '<li><a href="author.php?page='.($page -1).'&id='.$id.'&name='.$name.'">Prev</a></li>';
                                               }
                                               for($i=1;$i<=$total_page;$i++){
                                                ...
                                                echo '<li><a href="author.php?page='.$i.'&id='.$id.'&name='.$name.'"id='.$active.'>'.$i.'</a></li>';
                                            }
                                            if($page<$total_page){
                                                echo '<li><a href="author.php?page='.($page +1).'&id='.$id.'&name='.$name.'">Next</a></li>';
                                            }
                                            echo "</ul>";
                                       }
                            ?>
